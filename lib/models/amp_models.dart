...
class AmpModels {
  static const List<AmpModel> all = [
    ...
    AmpModel(
      ...
      'Blackface Lux',
      null,
      '1964 Fender Deluxe Reverb (Normal Ch, Input 1)',
    ),
    AmpModel(
      15,
      'Double Verb',
      null,
      '1965 Fender Twin Reverb (Normal Ch, Input 1)',
    ),
    ...
    AmpModel(
      ...
      'Plexi Jump Lead',
      null,
      '1968 Marshall Plexi Super Lead (Ch I+II Jumpered)',
    ),
    AmpModel(21, 'Plexi Variac', null, '1968 Marshall Super Lead (W/ Variac)'),
    ...
    AmpModel(27, 'Cali Crunch', null, '1985 Mesa/Boogie Mark II-C+ (Drive)'),
    ...
    AmpModel(
      ...
      'Diamondplate',
      'MS',
      '2001 Mesa/Boogie Triple Rectifier (Red Ch)',
    ),
    ...
    AmpModel(57, 'Blackface Vibro', 'CC', '1963 Fender Vibroverb 6G16'),
    AmpModel(58, 'Double Show', 'CC', '1967 Fender Dual Showman'),
    AmpModel(59, 'Silverface Bass', 'CC', '1972 Fender Bassman Head'),
    AmpModel(60, 'Mini Double', 'CC', '1996 Fender Mini-Twin'),
    AmpModel(61, 'Gibtone Expo', 'CC', '1960 Gibson GA-18T Explorer 14W'),
    ...
    AmpModel(65, 'Super O Thunder', 'CC', '1962 Supro Thunderbolt'),
    ...
    AmpModel(84, 'Rock Classic', 'BX', '1974 Ampeg SVT'),
    AmpModel(85, 'Flip Top', 'BX', '1968 Ampeg B-15 Portaflex'),
    AmpModel(86, 'Adam and Eve', 'BX', '1998 Eden Traveller WT-300'),
    AmpModel(87, 'Tweed B-Man', 'BX', '1958 Fender Bassman'),
    AmpModel(88, 'Silverface Bass', 'BX', '1967 Fender Bassman Head'),
    ...
    AmpModel(
      ...
      'Class A-30 Fawn',
      null,
      'Vox AC-30 (Normal Ch, Non Top Boost)',
    ),
    ...
    AmpModel(
      ...
      'Brit J-2000 #2',
      null,
      '2003 Marshall JCM2000 (w/ Germ Pedal)',
    ),
  ];
